...
import UIKit
import CoreData
class TuitionsAddViewController1: UIViewController , UITextFieldDelegate , UINavigationControllerDelegate ,
    UIPickerViewDataSource , UIPickerViewDelegate , DayChangeControllerDelegate //UITableViewDataSource ,UITableViewDelegate ,  // , UITableViewController ,
{
...
*/
    ...
    @IBAction func unwindWithSelectedDays(segue:UIStoryboardSegue) {
        if let controller = segue.sourceViewController as? DayListTableViewController//,
